...
const Posts = ({setCurrentPostID}) =>{
    ...
    const addAnimation = (e) =>{
        e.target.parentElement.parentElement.parentElement.classList.add('analogue');
    }

    return (
        <div className="posts-theme row">
            {posts && posts.map((post) => (
                <div key={post._id} className="post-theme col-md-5 mb-3" onAnimationEnd={() => dispatch(asyncDeletePost(post._id))}>
                    ...
                    <div className='post-footer-handler'>
                        ...
                        <div className="btn-handler">
                            ...
                            <button className="btn btn-outline-danger equal-btn-size" onClick={addAnimation} >
